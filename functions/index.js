...
app.post('/api/shorten', async (req, res) => {
    ...
    try {
        ...
        console.error('Error detallado al acortar:', error.message, error.stack);
...
app.get('/go/:shortId', async (req, res) => {
    ...
    try {
        ...
        console.error('Error detallado al redirigir:', error.message, error.stack);
        res.status(500).send('Ocurrió un error en el servidor: ' + error.message);
    }
});
